...
Connection pools are instantiated with either a `RDev\Models\Databases\SQL\Configs\ConnectionPoolConfig` or a configuration array ([learn more about configs](https://github.com/ramblingsofadev/RDev/tree/master/application/rdev/models/configs)).  Regardless of the type of config, it must have the following keys:
* "driver"
