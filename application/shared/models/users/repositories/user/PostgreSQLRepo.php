...
class PostgreSQLRepo extends Repositories\PostgreSQLRepo implements IUserRepo
{
     ...
     */
    public function __construct(SQL\RDevPDO $rDevPDO, Factories\UserFactory $userFactory, Token\ITokenRepo $passwordTokenRepo)
    {
