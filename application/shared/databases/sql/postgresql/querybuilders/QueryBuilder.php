...
use RamODev\Application\Shared\Databases\SQL\QueryBuilders;
...
class QueryBuilder extends QueryBuilders\QueryBuilder
{
    ...
    public function select($expression)
    {
        ...
        $queryClass = new \ReflectionClass("\\RamODev\\Application\\Shared\\Databases\\SQL\\PostgreSQL\\QueryBuilders\\SelectQuery");
