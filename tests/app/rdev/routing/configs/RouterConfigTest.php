 ...
 */
namespace RDev\Routing\Configs;
use RDev\Routing;
...
class RouterConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGroups()
    {
        ...
        $this->assertInstanceOf("RDev\\Routing\\Route", $getRoute);
        $this->assertInstanceOf("RDev\\Routing\\Route", $postRoute);
    ...
    public function testNestedGroups()
    {
        ...
        $this->assertInstanceOf("RDev\\Routing\\Route", $outsideGroupRoutes[0]);
        $this->assertInstanceOf("RDev\\Routing\\Route", $nestedGroupRoutes[0]);
        $this->assertEquals("", $nestedGroupRoutes[0]->getRawPath());
        $this->assertInstanceOf("RDev\\Routing\\Route", $nestedGroupRoutes[1]);
    ...
    {
        $compiler = "RDev\\Tests\\Routing\\Mocks\\RouteCompiler";
        $configArray = [
            "compiler" => $compiler
        ];
        $config = new RouterConfig($configArray);
