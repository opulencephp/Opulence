...
class QueryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->query = $this->getMockForAbstractClass("RDev\\Databases\\SQL\\QueryBuilders\\Query");
    }
    ...
    {
        $this->setExpectedException("RDev\\Databases\\SQL\\QueryBuilders\\InvalidQueryException");
