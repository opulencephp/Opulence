...
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThatDeleteReturnsDeleteQueryBuilder()
    {
        ...
        $this->assertInstanceOf("RDev\\Databases\\SQL\\QueryBuilders\\PostgreSQL\\DeleteQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Databases\\SQL\\QueryBuilders\\PostgreSQL\\InsertQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Databases\\SQL\\QueryBuilders\\PostgreSQL\\SelectQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Databases\\SQL\\QueryBuilders\\PostgreSQL\\UpdateQuery",
