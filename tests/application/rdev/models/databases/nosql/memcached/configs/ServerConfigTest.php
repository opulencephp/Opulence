...
class ServerConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatingServerWitNoOptionalSettingsSpecified()
    {
        ...
        $this->assertInstanceOf("RDev\\Models\\Databases\\NoSQL\\Memcached\\Server", $server);
    ...
    public function testUsingMultipleArrays()
    {
        ...
        $this->assertInstanceOf("RDev\\Models\\Databases\\NoSQL\\Memcached\\Server", $server1);
        ...
        $this->assertInstanceOf("RDev\\Models\\Databases\\NoSQL\\Memcached\\Server", $server2);
