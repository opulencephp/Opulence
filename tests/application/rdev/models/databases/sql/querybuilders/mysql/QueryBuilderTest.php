...
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThatDeleteReturnsDeleteQueryBuilder()
    {
        ...
        $this->assertInstanceOf("RDev\\Models\\Databases\\SQL\\QueryBuilders\\MySQL\\DeleteQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Models\\Databases\\SQL\\QueryBuilders\\MySQL\\InsertQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Models\\Databases\\SQL\\QueryBuilders\\MySQL\\SelectQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Models\\Databases\\SQL\\QueryBuilders\\MySQL\\UpdateQuery",
