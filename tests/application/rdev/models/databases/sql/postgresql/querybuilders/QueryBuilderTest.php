...
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThatDeleteReturnsDeleteQueryBuilder()
    {
        ...
        $this->assertInstanceOf("RDev\\Models\\Databases\\SQL\\PostgreSQL\\QueryBuilders\\DeleteQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Models\\Databases\\SQL\\PostgreSQL\\QueryBuilders\\InsertQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Models\\Databases\\SQL\\PostgreSQL\\QueryBuilders\\SelectQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Models\\Databases\\SQL\\PostgreSQL\\QueryBuilders\\UpdateQuery",
