...
use RamODev\Application\TBA\Databases\NoSQL\Redis\Servers;
...
class DatabaseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf("\\RamODev\\Application\\Shared\\Databases\\NoSQL\\Redis\\Server", $this->database->getServer());
    }
}