...
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThatDeleteReturnsDeleteQueryBuilder()
    {
        ...
        $this->assertInstanceOf("RDev\\Application\\Shared\\Models\\Databases\\SQL\\MySQL\\QueryBuilders\\DeleteQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Application\\Shared\\Models\\Databases\\SQL\\MySQL\\QueryBuilders\\InsertQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Application\\Shared\\Models\\Databases\\SQL\\MySQL\\QueryBuilders\\SelectQuery",
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("RDev\\Application\\Shared\\Models\\Databases\\SQL\\MySQL\\QueryBuilders\\UpdateQuery",
