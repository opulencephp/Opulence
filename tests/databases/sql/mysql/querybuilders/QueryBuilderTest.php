...
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThatDeleteReturnsDeleteQueryBuilder()
    {
        ...
        $this->assertInstanceOf("\\RamODev\\Application\\Databases\\SQL\\MySQL\\QueryBuilders\\DeleteQuery", $queryBuilder->delete("tableName", "tableAlias"));
    }
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("\\RamODev\\Application\\Databases\\SQL\\MySQL\\QueryBuilders\\InsertQuery", $queryBuilder->insert("tableName", array("columnName" => "columnValue")));
    }
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("\\RamODev\\Application\\Databases\\SQL\\MySQL\\QueryBuilders\\SelectQuery", $queryBuilder->select("tableName", "tableAlias"));
    }
    ...
    {
        $queryBuilder = new QueryBuilder();
        $this->assertInstanceOf("\\RamODev\\Application\\Databases\\SQL\\MySQL\\QueryBuilders\\UpdateQuery", $queryBuilder->update("tableName", "tableAlias", array("columnName" => "columnValue")));
    }
} 