...
class Lexer implements ILexer
{
    ...
    private array $directiveDelimiters = [];
    /** @var array The sanitized tag delimiters */
    private array $sanitizedTagDelimiters = [];
    /** @var array The unsanitized tag delimiters */
    private array $unsanitizedTagDelimiters = [];
    /** @var array The comment delimiters */
    private array $commentDelimiters = [];
    ...
    private array $streamCache = ['cursor' => PHP_INT_MAX, 'length' => null, 'stream' => ''];
