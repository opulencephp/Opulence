...
abstract class Reader
{
     ...
     */
    abstract public function readFromFile($path, $configClassName = "RDev\\Configs\\Config");
     ...
     * @throws \InvalidArgumentException Thrown if the config class name doesn't point to a class that implements IConfig
     */
    abstract public function readFromInput($input, $configClassName = "RDev\\Configs\\Config");
